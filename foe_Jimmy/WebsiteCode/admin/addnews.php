        ...
        <h2 class="text-center p-2">New News Post</h2>
          <form class="m-5" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
              ...
              <div class="form-group">
                ...
                <script>//this wysisyg editor was used to reduced time used in formatting post in html
                    ClassicEditor
              ...
              <!-- the checkbox aren't working yet, due to limited time and unresolve
              proper implementation of category in the database. idealing each post should have
