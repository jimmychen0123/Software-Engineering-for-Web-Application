     ...
     <footer>
     <!--create a row block as footer-->
        <div class="row footer_bg ml-0 mr-0">
<!--contact section-->
          <div class="col-md-3">
            <section class="contact">
              <h2>Contact</h2>
              <!--create navigation of phone and email contact -->
              <nav>
                <ul class="nav">
                  <li class="nav-item">
            ...
            <section class="subscribe">
              <form class="form-inline ">
                <input class="form-control mt-1 mb-1" type="email" placeholder="Enter email" aria-label="Search">
          ...
          <div class="col-md-3">
            <section class="our_friends">
              ...
              <nav>
                <ul class="pl-0">
                  <li>
                    <img src="images/logo_dot.png" alt="logo_dot">
...
<!--Donate button section-->
          <div class="col-md-3 d-inline-flex align-items-center justify-content-center">
              <!--Donate button -->
              <a href="donate.php" class="btn btnDonate">Donate</a>
<!--copy right statement at the bottom-->             
          </div>
