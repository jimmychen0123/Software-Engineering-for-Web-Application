  ...
  <div class="extra_header  inner_container mx-auto">
    <nav class="navbar navbar-expand-sm navbar-dark d-flex">
      ...
      <ul class="navbar-nav d-flex">
        <li class="nav-item"><a href="https://www.facebook.com/foeireland/" class="fa fa-facebook fa-lg nav-link"></a></li>
        <li class="nav-item"><a href="https://twitter.com/foeireland" class="fa fa-twitter fa-lg nav-link"></a></li>
        <li class="nav-item"><a href="https://www.youtube.com/user/friendsoftheearth" class="fa fa-youtube-play fa-lg nav-link"></a></li>
