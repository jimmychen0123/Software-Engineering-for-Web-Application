      ...
      <div class="mod_donation">
        ...
        <form class="" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
          <div class="p-2">
            ...
            <!--creating table and populate table from database-->
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th scope="col"><input type="checkbox" class="check" />Select</th>
                  <th scope="col">ID</th>
              ...
              <tbody>
                ...
                ?>
                <tr>
                  <td scope="row"><input type="checkbox" class="check" name = "don_rec[]" id="don_rec" value="<?php echo $rec['ID']; ?>">&nbsp;</td>
                  <td scope="row"><?php echo $rec['ID']; ?></td>
                  <td scope="row"><?php echo $rec['title']; ?></td>
                  <td scope="row"><?php echo $row['username']; ?></td>
                  <td scope="row"><?php echo substr($rec['date'],0,10); ?></td>
                </tr><?php } ?>
              <?php } ?>
              </tbody>
            </table>
