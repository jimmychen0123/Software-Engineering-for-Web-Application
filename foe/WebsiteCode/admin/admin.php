...
<!--use bootstrap card for each static as container -->
...
<!--Take Action Statistics row-->
        <section class="take_action_s p-2">
...
<!--Blog/News Statistics row-->
      <section class="blog_stat p-2">
