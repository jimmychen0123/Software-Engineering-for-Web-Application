...
<!--This php code is the implementation on how to populate contents from database-->
            <?php
            ...
            if(!$result){
              ...
              while($row = mysqli_fetch_array($result)){
                extract($row);
               ?>
<!--use jumbotron for calling extra attention to some special content or information.-->
...
<!--use collapse to hide and show large amount of content-->
            <div class="text-justify">
              ...
              <a class="btn btn-warning disabled" href="#">Take action</a>
            </div>
          </div>
        </div><?php $i++; }//while ?>
        <?php } //else?>
